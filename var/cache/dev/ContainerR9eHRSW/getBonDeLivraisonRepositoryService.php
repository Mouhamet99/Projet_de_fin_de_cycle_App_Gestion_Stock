 ...
 */
class getBonDeLivraisonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BonDeLivraisonRepository' shared autowired service.
     *
     * @return \App\Repository\BonDeLivraisonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BonDeLivraisonRepository.php';

        return $container->privates['App\\Repository\\BonDeLivraisonRepository'] = new \App\Repository\BonDeLivraisonRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
