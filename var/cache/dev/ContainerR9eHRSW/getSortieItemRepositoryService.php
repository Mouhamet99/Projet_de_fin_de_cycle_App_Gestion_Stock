 ...
 */
class getSortieItemRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SortieItemRepository' shared autowired service.
     *
     * @return \App\Repository\SortieItemRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SortieItemRepository.php';

        return $container->privates['App\\Repository\\SortieItemRepository'] = new \App\Repository\SortieItemRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
