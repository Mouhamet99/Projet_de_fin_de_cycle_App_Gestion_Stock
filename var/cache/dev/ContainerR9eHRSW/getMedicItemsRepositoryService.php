 ...
 */
class getMedicItemsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MedicItemsRepository' shared autowired service.
     *
     * @return \App\Repository\MedicItemsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MedicItemsRepository.php';

        return $container->privates['App\\Repository\\MedicItemsRepository'] = new \App\Repository\MedicItemsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
