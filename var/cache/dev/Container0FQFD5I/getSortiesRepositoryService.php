 ...
 */
class getSortiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SortiesRepository' shared autowired service.
     *
     * @return \App\Repository\SortiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SortiesRepository.php';

        return $container->privates['App\\Repository\\SortiesRepository'] = new \App\Repository\SortiesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
