<?php
namespace App\MesServices\fpdf;
use Fpdf\Fpdf;
//require('fpdf.php');
define('EURO', chr(128) );
...
//ajout du bon de commande associé
function addNumBdc($numBdc)
{
    $this->SetFont( "Arial", "B", 10);
    $r1  = $this->w - 80;
    $r2  = $r1 + 70;
    ...
    $this->Line( $r1, $mid, $r2, $mid);
    $this->SetXY( $r1 + 16 , $y1+1 );
    $this->Cell(40, 4, "Bon de commande associé", '', '', "C");
    $this->SetFont( "Arial", "", 10);
    $this->SetXY( $r1 + 16 , $y1+5 );
    $this->Cell(40, 5, $numBdc, '', '', "C");
}
